            ...
            <div class="folder-white__body">
                <div class="content-hero__inner">
                    <div class="content-hero__body">
                        ...
                        <p class="content-hero__copy">Используйте платформу для продвижения своей компании и&nbsp;товаров без лишних затрат.</p>
                        <p class="content-hero__cta">
                            <a href="#apply" class="btn-cta">Стать партнером</a>
                        </p>
                    </div>
                    <div class="content-hero__image"><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/hero.jpg" alt="" loading="lazy"></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="suppliers-stats__inner">
            <div class="suppliers-stats__body">
                <div class="suppliers-stats__header">
                    ...
                    <p class="suppliers-stats__header-copy">Целевая аудитория&nbsp;— предпринимателии малые транспортные компаниис автопарком до&nbsp;15&nbsp;«сцепок».</p>
                </div>
                <ul class="suppliers-stats__chips">
                    <li class="suppliers-stats__chips-item">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/users-auto.png" alt="" loading="lazy"> Начальники автоколонн
                    </li>
                    <li class="suppliers-stats__chips-item">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/users-top.png" alt="" loading="lazy"> Руководители компаний
                    </li>
                    <li class="suppliers-stats__chips-item">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/users-logistics.png" alt="" loading="lazy"> Логисты
                    </li>
                    <li class="suppliers-stats__chips-item">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/users-drivers.png" alt="" loading="lazy"> Водители
                    </li>
                    <li class="suppliers-stats__chips-item">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/users-accountants.png" alt="" loading="lazy"> Бухгалтеры
                    </li>
                    <li class="suppliers-stats__chips-item">
                        <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/users-mechanics.png" alt="" loading="lazy"> Механики
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="suppliers-customers__inner">
            <div class="suppliers-customers__box">
                ...
                <div class="suppliers-customers__graph">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/graph.svg" alt="">
    ...
    <section class="suppliers-partners">
        <div class="suppliers-partners__inner">
            ...
            <ul class="suppliers-partners__list">
                <li><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/clients-dpd.svg" alt="" loading="lazy"></li>
                <li><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/clients-gazprom.svg" alt="" loading="lazy"></li>
                <li><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/clients-sber.svg" alt="" loading="lazy"></li>
                <li><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/clients-5.svg" alt="" loading="lazy"></li>
                <li><img src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/clients-dpd.svg" alt="" loading="lazy"></li>
            </ul>
        </div>
    </section>
            ...
            <div class="suppliers-approach__list">
                <article class="suppliers-approach__item">
                    <div class="suppliers-approach__item-image"><img
                            src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/approach-1.jpg" loading="lazy" alt=""></div>
                    <h4 class="suppliers-approach__item-heading">Размещайтесь на&nbsp;площадке с&nbsp;лояльной аудиторией</h4>
                </article>
                <article class="suppliers-approach__item">
                    <div class="suppliers-approach__item-image"><img
                            src="<?= SITE_TEMPLATE_PATH ?>/assets/img/suppliers/approach-2.jpg" loading="lazy" alt=""
                        ></div>
                    <h4 class="suppliers-approach__item-heading">Получайте отзывы на&nbsp;ваши товары в&nbsp;личном кабинете для улучшения продуктов</h4>
                </article>
            </div>
        </div>
    </section>
                    ...
                    <form action="#" class="form-apply form form_required">
                        ...
                        <div class="form-apply__body">
                            ...
                            <div class="form__submit">
                                <button class="btn-cta" type="submit">Получить</button>
                                <p class="form__submit-agreement">Нажимая на&nbsp;кнопку «Получить», вы&nbsp;принимаете согласие на&nbsp;
